import { logging, rpc, sc, u, wallet } from "../../bhp-core/lib";
import * as abi from "./abi";
const log = logging.default("brc5");
 ...
 * @param url Url of the BHP node to query.
 * @param scriptHash ScriptHash of the BRC5 contract.
 ...
 * @param url RPC Node url to query.
 * @param scriptHashArray Array of BRC5 contract scriptHashes.
 * @param address Optional address to query the balance for. If provided, the returned object will include the balance property.
 */
