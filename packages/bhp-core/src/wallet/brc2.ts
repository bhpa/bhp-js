/**
 * BRC2 - Private Key Encryption based on AES.
...
import { DEFAULT_SCRYPT, BRC_FLAG, BRC_HEADER } from "../consts";
...
/**
 * Encrypts a WIF key using a given keyphrase under BRC-2 Standard.
 ...
 * @param scryptParams Optional parameters for Scrypt. Defaults to BRC2 specified parameters.
...
/**
 * Decrypts an encrypted key using a given keyphrase under BRC-2 Standard.
 * @param encryptedKey The encrypted key (58 chars long).
 * @param keyphrase The password will be encoded as UTF-8 and normalized using Unicode Normalization Form C (NFC).
 * @param scryptParams Parameters for Scrypt. Defaults to BRC2 specified parameters.
