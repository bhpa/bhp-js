import { compareBhpObjectArray, BhpObject } from "../../helper";
 ...
 */
export class AssetBalance implements BhpObject {
  public unspent: Coin[];
  public spent: Coin[];
  ...
  public equals(other: Partial<AssetBalanceLike>): boolean {
    return (
      compareBhpObjectArray(this.unspent, other.unspent) &&
      compareBhpObjectArray(this.spent, other.spent) &&
      compareBhpObjectArray(this.unconfirmed, other.unconfirmed)
    );
  }
}
