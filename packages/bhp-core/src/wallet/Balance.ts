 ...
 * Contains balances for both UTXO assets and BRC5 tokens.
 */
export class Balance {
  ...
  /** The symbols of BRC5 tokens found in this Balance. Use this symbol to find the corresponding balance in the tokens object. */
  ...
  /**
   * Adds a new BRC-5 Token to this Balance.
   * @param sym - The BRC-5 Token Symbol to refer by.
   ...
   * @param url BHP Node to check against.
   */
