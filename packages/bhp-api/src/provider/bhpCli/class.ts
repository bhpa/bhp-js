import { logging, rpc, u, wallet } from "../../../../bhp-core/lib";
import { PastTransaction, Provider } from "../common";
import { getBalance, getClaims, getMaxClaimAmount } from "./core";

const log = logging.default("api");

export class BhpCli implements Provider {
  public get name() {
    return `BhpCli[${this.url}]`;
  }
  private url: string;
  ...
  public constructor(url: string) {
    ...
    log.info(`Created BhpCli Provider: ${this.url}`);
  }
